...
/*
Eventually becomes the current asset wrapper object (as generated by the __imageAsset__, __spriteAsset__ and __videoAsset__ factories).
*/
		asset: null,
...
/*
Setting the Asset object. Updating the asset will set the dirtyAsset flag.
*/
...
Most of these attributes will be updated by the Asset wrappers, to which the factory instances have subscribed, each time a change to the underlying source takes place.
*/
	P.initAssetAttributes = function () {

/*
Eventually becomes a handle to the current asset wrapper object's DOM element.
*/
		this.source = null;

/*
Source natural dimensions - updated as part of the asset wrapper's notifySubscribers functionality whenever the asset's source's dimensions change. This happens as soon as the source file loads; also, for instance, when an &lt;img> element with a srcset attribute decides to use a different source file to meet evolving viewport dimension changes.
*/
		this.sourceNaturalWidth = 0;
		this.sourceNaturalHeight = 0;

/*
Flag indicating that the Asset file(s) has successfully loaded - updated as part of the asset wrapper's notifySubscribers functionality
*/
		this.sourceLoaded = false;

/*
Sprite-specific attributes - updated as part of the __spriteAsset__ wrapper's notifySubscribers functionality.
*/
