...
P.checkSource = function (width, height) {
    ...
    // console.log(this.name, 'checkSource', width, height, this.dirtyData, source.width, source.height);
...
// `addAttribute`, `removeAttribute` - we can use these functions to add and remove other attributes to the ReactionDiffusionAsset object.
