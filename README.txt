...
0. Review processes for dismantling/deleting everything 
* make sure they work
* make sure it happens cleanly
* minimize/eliminate as much leakage as possible

1. Canvas dynamic generation (adding to page and/or stack), canvas cloning
* code up demo DOM-012 to test functionality
* also need to make sure we're making good use of current canvas/group stuff

2. Generate Images and/or Picture entitys from other entitys, groups, cells, etc
...
9. Think about developing a Grid artefact (eg for demos DOM-013, Canvas-019)
...
11. Displacement map filter-like functionality
* just for the challenge of it

12. Work out how to get and use SVG into the system as assets which can be used by Picture/Pattern etc
