var mycode = function() {
	...
	scrawl.newAnimation({
		fn: function() {
			...
			data.innerHTML = '<br />pasteX: ' + current_pasteX + ', pasteY: ' + current_pasteY + ', pasteWidth: ' + current_pasteWidth + ', pasteHeight: ' + current_pasteHeight + '<br />copyX: ' + current_copyX + ', copyY: ' + current_copyY + ', copyWidth: ' + current_copyWidth + ', copyHeight: ' + current_copyHeight + '<br />handleX: ' + current_handleX + ', handleY: ' + current_handleY + ', scale: ' + current_scale + ', roll: ' + current_roll + ', flip: ' + current_flip + '<br />&nbsp;<br />start.x: ' + peacock.start.x + '; start.y: ' + peacock.start.y + '; handle.x: ' + peacock.handle.x + '; handle.y: ' + peacock.handle.y + '; copy.x: ' + peacock.copy.x + '; copy.y: ' + peacock.copy.y + '<br />width: ' + peacock.width + '; height: ' + peacock.height + '; copyWidth: ' + peacock.copyWidth + '; copyHeight: ' + peacock.copyHeight + '; scale: ' + peacock.scale;
