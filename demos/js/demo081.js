var mycode = function() {
	...
	var cellBox,
		...
		current_entityblock_startX = 350,
		...
		current_entitygrad_startX = 0,
		current_entitygrad_startY = 0,
		current_entitygrad_endX = 100,
		current_entitygrad_endY = 100,
	...
	input_entitygrad_startX_abs.value = 0;
	input_entitygrad_startY_abs.value = 0;
	input_entitygrad_endX_abs.value = 100;
	input_entitygrad_endY_abs.value = 100;
	input_entitygrad_startX_rel.value = 0;
	input_entitygrad_startY_rel.value = 100;
	input_entitygrad_endX_rel.value = 0;
	input_entitygrad_endY_rel.value = 0;
