var mycode = function() {
	...
	var cellBox,
		...
		current_spriteblock_startX = 350,
		...
		current_cellgrad_startX = 0,
		current_cellgrad_startY = 0,
		current_cellgrad_endX = 600,
		current_cellgrad_endY = 400,
		current_spritegrad_startX = 0,
		current_spritegrad_startY = 0,
		current_spritegrad_endX = 100,
		current_spritegrad_endY = 100,
	...
	input_cellgrad_startX_abs.value = 0;
	input_cellgrad_startY_abs.value = 0;
	input_cellgrad_endX_abs.value = 600;
	input_cellgrad_endY_abs.value = 400;
	input_cellgrad_startX_rel.value = 0;
	input_cellgrad_startY_rel.value = 100;
	input_cellgrad_endX_rel.value = 0;
	input_cellgrad_endY_rel.value = 0;
	...
	input_spritegrad_startX_abs.value = 0;
	input_spritegrad_startY_abs.value = 0;
	input_spritegrad_endX_abs.value = 100;
	input_spritegrad_endY_abs.value = 100;
	input_spritegrad_startX_rel.value = 0;
	input_spritegrad_startY_rel.value = 100;
	input_spritegrad_endX_rel.value = 0;
	input_spritegrad_endY_rel.value = 0;
