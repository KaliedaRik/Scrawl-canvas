...
Alternatively, a zip package of the v8.3.0 files can be downloaded from this link: [scrawl.rikweb.org.uk/downloads/scrawl-canvas_8-3-0.zip](https://scrawl.rikweb.org.uk/downloads/scrawl-canvas_8-3-0.zip) - this package only includes the minified file.
...
```
<script type="module">
    import scrawl from 'https://unpkg.com/scrawl-canvas@8.3.0';
    [...]
</script>
```
