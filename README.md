...
Alternatively, a zip package of the v8.8.2 files can be downloaded from this link: [scrawl.rikweb.org.uk/downloads/scrawl-canvas_8-8-2.zip](https://scrawl.rikweb.org.uk/downloads/scrawl-canvas_8-8.2.zip) - that package only includes the minified file.
