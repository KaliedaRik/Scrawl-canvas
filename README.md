...
Alternatively, a zip package of the v8.19.0 files can be downloaded from this link: [scrawl.rikweb.org.uk/downloads/scrawl-canvas_8-19-0.zip](https://scrawl.rikweb.org.uk/downloads/scrawl-canvas_8-19-0.zip) - that package only includes the minified file.
...
```html
<script type="module">
    import * as scrawl from 'https://unpkg.com/scrawl-canvas@8.19.0';
    [...]
</script>
```
