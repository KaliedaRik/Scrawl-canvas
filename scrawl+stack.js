...
window.scrawl = (function(){
	var scrawl = {
		...
		anim: {},
		animnames: [],
		nameslist: ['objectnames', 'padnames', 'cellnames', 'imagenames', 'groupnames', 'designnames', 'spritenames', 'pointnames', 'linknames', 'ctxnames', 'animnames', 'stacknames', 'elementnames'],
		radian: Math.PI/180,
		degree: 180/Math.PI,
		mouseX: 0,
		mouseY: 0,
		...
		addCanvasToPage: function(items){
			...
			var myStack = items.stackName || items.canvasName || myName || 'stack_'+parseInt(Math.random()*1000000);
			var myStk = document.getElementById(items.stackName) || false;
			if(!myStk){
			...
			var myCanvasName = (myStk.id === myName) ? myName+'_display' : myName;
			var myCanvas = document.createElement('canvas');
			myCanvas.id = myCanvasName;
			myStk.appendChild(myCanvas);
			var DOMCanvas = document.getElementById(myCanvasName);
